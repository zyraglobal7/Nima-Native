...
/**
 * Update occasions the user styles for (Work, Casual, Evening, etc.).
 * Used by the missing-data modal on the For You page.
 */
export const updateOccasions = mutation({
  args: {
    occasions: v.array(v.string()),
  },
  returns: v.id('users'),
