...
/**
 * Every morning at 6am EAT (3am UTC): generate fresh wardrobe-based combos
 * for all active users and send a push notification.
 */
crons.daily(
  'generate-daily-wardrobe-recommendations',
  { hourUTC: 3, minuteUTC: 0 },
  internal.recommendations.mutations.generateDailyWardrobeForAll
);
