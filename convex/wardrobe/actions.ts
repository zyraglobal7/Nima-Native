                ...
                text: `Identify every distinct clothing or fashion item visible in this photo. There may be one item or many (e.g. multiple shirts, belts, shoes). Return ONLY valid JSON with no markdown:
{
  "items": [
    {
      "description": "concise but specific description e.g. Navy blue slim-fit chinos with cuffed hem",
      "category": "one of: tops, bottoms, shoes, outerwear, accessories, dresses",
      "subcategory": "specific type e.g. chinos, sneakers, sunglasses, blazer, hoodie, polo shirt",
      "tags": ["include 6-10 detailed tags covering: color, fabric/material, fit/silhouette, pattern/print, style/aesthetic, notable details, suitable occasions"],
      "color": "primary color",
      "season": ["all-season"],
...
TAGS GUIDANCE: Be detailed and specific. Good example for a hoodie: ["black", "cotton", "oversized", "pullover", "kangaroo-pocket", "ribbed-cuffs", "streetwear", "casual", "layering-piece", "urban"]. Bad example: ["black", "hoodie"]. Include fabric (cotton, denim, leather, silk, linen, polyester), fit (slim, oversized, relaxed, cropped, tailored), pattern (solid, striped, graphic, plaid, floral), style (streetwear, preppy, minimalist, bohemian, athleisure), and any notable construction details (distressed, embroidered, pleated, zip-up, button-down).
      ...
      const scanPrompt = `This is a photo of someone's closet/wardrobe. Identify each clearly visible clothing item. Return ONLY valid JSON:
{
  "items": [
    {
      "description": "Navy blue slim-fit chinos with cuffed hem",
      "category": "bottoms",
      "subcategory": "chinos",
      "tags": ["navy", "cotton", "slim-fit", "cuffed", "smart-casual", "versatile", "tailored", "mid-rise"],
      "color": "navy blue",
...
TAGS GUIDANCE: Include 6-10 detailed tags per item covering: color, fabric/material (cotton, denim, leather, silk, linen), fit/silhouette (slim, oversized, relaxed, cropped, tailored), pattern (solid, striped, graphic, plaid), style/aesthetic (streetwear, preppy, minimalist, bohemian, athleisure), and notable details (distressed, embroidered, pleated, zip-up, ribbed-cuffs).
